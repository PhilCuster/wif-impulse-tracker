import { IonButton, IonContent, IonHeader, IonItem, IonItemDivider, IonLabel, IonList, IonListHeader, IonPage, IonSelect, IonSelectOption, IonTitle, IonToolbar } from "@ionic/react";
    ...
    if (match.params.id === 'axis') {
        currentActions = (
            <IonList>
                <IonListHeader>
                    <IonLabel>
                        Select Actions for the Axis
                    </IonLabel>
                </IonListHeader>

                <IonItem>
                    <IonLabel>Germany</IonLabel>
                    <IonSelect value={germanAction} placeholder="Choose Action" onIonChange={e => setGermanAction(e.detail.value)}>
                ...
                <IonItem>
                    ...
                    <IonSelect value={italianAction} placeholder="Choose Action" onIonChange={e => setItalianAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
                ...
                <IonItem>
                    ...
                    <IonSelect value={japaneseAction} placeholder="Choose Action" onIonChange={e => setJapaneseAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
        ...
        currentActions = (
            <IonList>
                <IonListHeader>
                    <IonLabel>
                        Select Actions for the Allies
                    </IonLabel>
                </IonListHeader>

                <IonItem>
                    <IonLabel>Commonwealth</IonLabel>
                    <IonSelect value={cwAction} placeholder="Choose Action" onIonChange={e => setCwAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
                ...
                <IonItem>
                    ...
                    <IonSelect value={frenchAction} placeholder="Choose Action" onIonChange={e => setFrenchAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
                ...
                <IonItem>
                    ...
                    <IonSelect value={usAction} placeholder="Choose Action" onIonChange={e => setUsAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
                ...
                <IonItem>
                    ...
                    <IonSelect value={sovietAction} placeholder="Choose Action" onIonChange={e => setSovietAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
                ...
                <IonItem>
                    ...
                    <IonSelect value={chineseAction} placeholder="Choose Action" onIonChange={e => setChineseAction(e.detail.value)}>
                        <IonSelectOption value="land">Land</IonSelectOption>
                        <IonSelectOption value="naval">Naval</IonSelectOption>
                        <IonSelectOption value="air">Air</IonSelectOption>
                        <IonSelectOption value="combined">Combined</IonSelectOption>
        ...
        <IonPage>
            ...
            <IonContent>
                ...
                <Link to={{
                    ...
                    <IonButton expand="block" size="large" color="primary">Done</IonButton>
                </Link>
            </IonContent>
        </IonPage>
    );
